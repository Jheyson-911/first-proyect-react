...
export const Navegacion = () => {
  return (
    <div className={`h-screen bg-green-main overflow-y-scroll sticky top-0`}>
      <div className='flex flex-col gap-4 md:gap-0 lg:gap-10 justify-center py-5'>
        <img
          src={avatar}
          alt='Avatar del usuario'
          className='w-1/2 rounded-full self-center md:w-1/4 lg:w-1/2'
        />
        <div>
          <p className='text-white-main font-semibold text-2xl text-center md:text-lg lg:text-3xl'>
            Willis Corto
          </p>
          <p className='italic text-white-main text-center md:text-xs lg:text-2xl'>
        ...
        <div className='flex justify-evenly px-6 md:mt-5'>
          <div>
            <svg
              viewBox='0 0 512 512'
              fill='currentColor'
